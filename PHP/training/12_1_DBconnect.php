...
// mysqli_fetch_row() 함수는 인덱스 배열 형식으로 결과 집합에서 
// 다음 행을 가져옴 . 즉, 각 열에 대한 값은 숫자 인덱스로 반환

// mysqli_fetch_assoc()함수는 연관 배열 형식으로 결과 집합에서 다음 행을 가져옴
// 각 열에 대한 값은 해당 열의 이름으로 구성된 연관 배열로 반환
